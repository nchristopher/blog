...
**UPDATE**: Some users can [unlock dark mode](#unlocking-dark-mode) **without** switching channels. It's worth checking if [those flags](#unlocking-dark-mode) exist - if not, follow these instructions first.
